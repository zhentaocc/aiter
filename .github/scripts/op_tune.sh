...
declare -a tune_jobs=(
  ...
  "ck_batched_gemm_a8w8_blockscale:csrc/ck_batched_gemm_a8w8_blockscale:op_tests/test_batched_gemm_a8w8_blockscale.py:python3 csrc/ck_batched_gemm_a8w8_blockscale/batched_gemm_a8w8_blockscale_tune.py -i aiter/configs/a8w8_blockscale_untuned_batched_gemm.csv -o aiter/configs/a8w8_blockscale_tuned_batched_gemm.csv"
